...
const licenses = [
  ...
  { name: "Лицензии и допуски", desc: "Работаем в полном соответствии с требованиями законодательства" },
  { name: "Гарантия качества", desc: "Гарантия на все выполненные работы 12 месяцев" },
]
